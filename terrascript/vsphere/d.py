...
class vsphere_datacenter(_data): pass
...
class vsphere_network(_data): pass
network = vsphere_network

class vsphere_tag(_data): pass
tag = vsphere_tag

class vsphere_tag_category(_data): pass
tag_category = vsphere_tag_category

class vsphere_vmfs_disks(_data): pass
